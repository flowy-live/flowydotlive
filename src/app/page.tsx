...
export default function Home() {
  ...
  return (
    <main className="bg-[#1e1e1e] min-h-screen">
      <div className="fixed py-1 top-0 left-0 w-full bg-gradient-to-r from-teal-500 to-teal-900 flex flex-row justify-center">
        <p className="font-bold text-teal-100">Target launch for flowy 1.0 device: <b>October 1st, 2024</b></p>
      </div>
      <div className="flex flex-col lg:p-24 p-5">
